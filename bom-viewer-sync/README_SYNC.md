...
The Phase B branch is not merged. `data.js`, `outputs/`, and Desktop remain unchanged; do not publish them until the PR is separately approved and integrated.
