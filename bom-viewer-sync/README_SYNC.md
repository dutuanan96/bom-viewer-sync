...
The build generates `admin.html`, `app-admin.js`, `styles.css`, and `viewer.html`. Never edit these files directly. Their cache/build identifier is a dynamic 12-character source hash (current output: `e20a4df8f465`), not a fixed version string.
