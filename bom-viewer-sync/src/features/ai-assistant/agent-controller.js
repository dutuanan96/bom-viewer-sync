...
- CRITICAL: If the context shows 'canEditRevision: false', you MUST NOT use the 'apply_mutation' tool. Instead, reply in the user's language explaining that the current revision is locked (official release) and they must switch to a Draft to edit.
