...
Object.assign(TEXT.zh, {
  ...
  'ai.localFallback.resultsTruncated': '匹配结果超过 50 条；当前仅显示前 50 条。请下载 Excel 查看全部结果。',
...
Object.assign(TEXT.vi, {
  ...
  'ai.localFallback.resultsTruncated': 'Có hơn 50 kết quả phù hợp; hiện chỉ hiển thị 50 kết quả đầu. Hãy tải Excel để xem toàn bộ kết quả.',
