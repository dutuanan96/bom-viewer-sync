...
import { buildB201ProposalBatches } from './features/ecn-proposal/b201-gray-variant-proposal-builder.js';
...
const TEXT = {
  ...
  vi: {
    ...
    productCatalogTitle: 'Danh mục sản phẩm',
...
Object.assign(TEXT.zh, {
  ...
  'ai.localFallback.packagingRulePending': '包装规则待确认，不能作为生产依据。',
  ...
  'ai.localFallback.labelDifferenceNotice': '贴标差异预警（序号标不同）',
  'ai.localFallback.labelDifferenceWarning': '序号标差异',
  'ai.localFallback.labelMatching': '序号标一致',
  ...
  loadEcnProposal: '加载工程变更方案 (ECN)',
  loadEcnProposalDone: '工程变更方案 (ECN)：所有批次已应用完毕。',
  'ai.ecn.impactTitle': '工程变更影响分析 (ECN Impact Analysis)',
  'ai.ecn.targetMaterial': '目标物料',
  'ai.ecn.currentSpec': '现行规格',
  'ai.ecn.newSpec': '拟变更规格',
  'ai.ecn.affectedScope': '受影响范围',
  'ai.ecn.factoryStreams': '四维业务影响与行动清单',
  'ai.ecn.labelStream': '序号标与装配说明书 (Label & Assembly Manual)',
  'ai.ecn.hardwareStream': '五金包与采购库存 (Hardware & Procurement)',
  'ai.ecn.drawingStream': '2D图纸与车间模具 (Drawings & Tooling)',
  'ai.ecn.packagingStream': '外箱包材与装柜容积 (Carton & Logistics)',
  ...
  continueLoadEcnProposal: '继续加载工程变更方案 (ECN)',
...
Object.assign(TEXT.vi, {
  ...
  'ai.localFallback.representativeColor': 'Màu sản phẩm đại diện',
  ...
  'ai.localFallback.packagingRulePending': 'Quy tắc đóng gói đang chờ xác nhận, không dùng làm căn cứ sản xuất.',
  ...
  'ai.localFallback.usedProductsWithRevision': '[Mã vị trí] Sản phẩm sử dụng (phiên bản hiệu lực)',
  ...
  'ai.localFallback.commonMaterials': 'Vật liệu dùng chung',
  'ai.localFallback.identicalMatch': 'Khớp hoàn toàn',
  'ai.localFallback.packingDifferenceReminder': 'Nhắc nhở đóng gói (Lưu ý khác tem dán/số hiệu)',
  ...
  'ai.localFallback.similarityScore': 'Độ tương đồng BOM',
  'ai.localFallback.labelDifferenceNotice': 'Cảnh báo lệch tem dán (khác mã vị trí/số hiệu)',
  'ai.localFallback.labelDifferenceWarning': 'Lệch tem số hiệu',
  'ai.localFallback.labelMatching': 'Khớp tem số hiệu',
  'ai.localFallback.quantityDifference': 'Lệch số lượng',
  ...
  loadEcnProposal: 'Nạp đề xuất thay đổi kỹ thuật (ECN)',
  loadEcnProposalDone: 'Đề xuất thay đổi kỹ thuật (ECN): Tất cả các batch đã được áp dụng.',
  'ai.ecn.impactTitle': 'Phân tích tác động thay đổi kỹ thuật (ECN Impact Analysis)',
  'ai.ecn.targetMaterial': 'Vật tư mục tiêu',
  'ai.ecn.currentSpec': 'Quy cách hiện hành',
  'ai.ecn.newSpec': 'Quy cách đề xuất',
  'ai.ecn.affectedScope': 'Phạm vi ảnh hưởng',
  'ai.ecn.factoryStreams': '4 luồng tác động và kế hoạch hành động xưởng',
  'ai.ecn.labelStream': 'Tem số hiệu và sách hướng dẫn lắp ráp',
  'ai.ecn.hardwareStream': 'Túi ngũ kim và mua hàng / tồn kho',
  'ai.ecn.drawingStream': 'Bản vẽ 2D và máy cắt CNC / đồ gá xưởng',
  'ai.ecn.packagingStream': 'Thùng carton và thể tích đóng container',
  ...
  continueLoadEcnProposal: 'Tiếp tục nạp đề xuất kỹ thuật (ECN)',
